...
cd v2-ui
chmod +x v2-ui bin/v2ray-v2-ui
cp -f v2-ui.service /etc/systemd/system/
systemctl daemon-reload
systemctl enable v2ray-v2-ui
systemctl restart v2ray-v2-ui
 
curl -o /usr/bin/v2-ui -Ls https://raw.githubusercontent.com/irwanmohi/v2-ui/master/v2-ui.sh
